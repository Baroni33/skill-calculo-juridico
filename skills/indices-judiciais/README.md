...
- **`tipo: nominal | percentual`** — o campo que não pode faltar (R3). Nominal
  (Ufir, BTN, OTN, ORTN) reflete a inflação do mês anterior; percentual (INPC,
  IPCA, IGP) reflete a do próprio mês. Trocar entre tipos sem ajustar a defasagem
  desloca o cálculo em um mês.
